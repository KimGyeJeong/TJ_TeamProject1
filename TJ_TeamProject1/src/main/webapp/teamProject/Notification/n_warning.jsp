...
<h3 align="right">사용자:<%=id %></h3>
	...
	int endRow = currentPage * pageSize; 
 	...
 	count = dao.notificationListCount4(id);
 
 	
 	
 	
 	if(count >0){
 		NotificationList=dao.getNotificationList4(startRow, endRow, id);
 	}
...
<body>
	...
	<%}else{ // 글이 하나라도 있으면 %>
		...
		<table>
			...
			<td style='display:none'><input type='text' value='n_warning.jsp' name="where"></td>
			</tr>
