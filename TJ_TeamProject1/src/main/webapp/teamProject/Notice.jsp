...
count = dao.noticeCount2();

SimpleDateFormat sdf = new SimpleDateFormat("yy-MM-dd");

if (count > 0) {

	NotificationList = dao.noticeList2(startRow, endRow);
...
<body>
	...
	<div>
		...
		<div align="center">
			...
			<a class="pageNums" href="Notice.jsp?pageNum=<%=startPage - 1%>">
				&lt; &nbsp; </a>
			...
			<a class="pageNums" href="Notice.jsp?pageNum=<%=l%>"> &nbsp; <%=l%>
				&nbsp;
